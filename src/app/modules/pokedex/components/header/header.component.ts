  ...
  ngOnInit(): void {
    this.sub.add(
      this.searchInputControl.valueChanges
        ...
        .subscribe((val) => this.store.dispatch(filterPokemon({ name: val })))
    );
    this.sub.add(this.showFavoritesControl.valueChanges.subscribe(() => this.store.dispatch(toggleShowFavorites())));
